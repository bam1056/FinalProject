...
class Contact extends Component {
  render () {
    return <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '400px', margin: '0 auto', flexWrap: 'wrap'}}className='contact'>
      <Flex flexColumn col={10} wrap>
        ...
        <Text style={{width: '300px', fontFamily: 'Roboto'}}>
